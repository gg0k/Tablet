...
QToolButton:checked { background-color: #4b6eaf; border: 1px solid #5c85d6; }
QPushButton { background-color: #4c5052; color: white; border: 1px solid #5c6062; padding: 5px; border-radius: 3px; }
QPushButton:hover { background-color: #5c6062; }
QGraphicsView { border: none; background-color: #555; }
QLabel { color: #ccc; }
